...
--Verifies the vectors given to a function, was doing it multiple times so made a function.
...
function Vector2:Normal(vector)
	...
	--I would explain how that was derived, but that's too much work lmao.
	return Vector2(-y, x)
end
